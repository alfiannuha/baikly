<template>
  <div style="min-height: 100vh;">
    ...
    <div
      ...
      <v-card width="610px" :height="user.user.is_with_google == 1 ? '720px' : '680px'" class="mt-10 rounded-xl box-shadow == 1">
          ...
          <div>
            <ValidationObserver ref="observer">
              <v-form class="text-left">
                <div v-show="user.user.is_with_google == 1">
                  <ValidationProvider
                    name="Password"
    ...
    async save() {
      ...
      if (isValid) {
        await post(`auth/personal-info`, {
          id : "da6aee6e-c3ee-4e80-8776-c2bcbda53e17",
          job_title : this.form.title_job,
          mobilephone : this.form.phone_number,
          gender : this.form.gender,
          company_name : this.form.company_name,
          total_employee : this.form.total_employee ? this.form.total_employee : 2
        }).then(response => {
